    ...
    <>
      <header className="min-h-screen flex items-center bg-[#282c34]">
        <div className="container mx-auto text-center px-4 sm:px-6">
          {/* Use the new header font */}
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight text-white font-header">
            Stop searching.
            <br />
          ...
          {/* This paragraph will automatically use the 'sans' (Inter Tight) font */}
